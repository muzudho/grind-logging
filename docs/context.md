...
* 📄 `[2025-11-23 15:34 +09] baseball-watching/src/main.go 176: open "baseball-watching/assets/data/score-book-1950-03.json" file, but it not found.` のようなメッセージを、 **ログ** と呼びます。

☕ 休憩：  

**ログ** は、丸太という意味です。  
丸太は、途中の説明は省略するものの、 **航海日誌** という意味です。航海日誌は **記録** という意味でも使われる言葉です。  
コンピューター・プログラミングでは、コンピューターが動いている（または動けなくなる前の）記録という意味でログという言葉が用いられています。  
